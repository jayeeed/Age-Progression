...
if __name__ == '__main__':
    ...
    parser.add_argument('--c2_dim', type=int, default=13, help='dimension of domain labels (2nd dataset)')
    parser.add_argument('--celeba_crop_size', type=int, default=178, help='crop size for the CelebA dataset')
    parser.add_argument('--rafd_crop_size', type=int, default=200, help='crop size for the RaFD dataset')
    parser.add_argument('--image_size', type=int, default=200, help='image resolution')
    ...
    parser.add_argument('--rafd_image_dir', type=str, default='data/RaFDffhq256/train')
